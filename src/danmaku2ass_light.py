...
# The light version of danmaku2ass.py whose original author is m13253.
# Modified by Yangwang for program m4sMerge_bili.
...
CommentFormatMap = {'Bilibili': ReadCommentsBilibili, 'Bilibili2': ReadCommentsBilibili2}
